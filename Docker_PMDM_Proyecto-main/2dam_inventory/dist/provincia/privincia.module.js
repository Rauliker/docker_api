...
const provinvia_entity_1 = require("./provinvia.entity");
...
exports.ProvinciaModule = ProvinciaModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([provinvia_entity_1.Provincia])],
        controllers: [provincia_controller_1.ProvinciaController],
        exports: [typeorm_1.TypeOrmModule.forFeature([provinvia_entity_1.Provincia])],
        providers: [provincia_service_1.ProvinciaService],
    })
], ProvinciaModule);
//# sourceMappingURL=privincia.module.js.map