...
export declare class UserController {
    ...
    createUser(createUserDto: CreateUserDto, files: Express.Multer.File[]): Promise<import("./users.entity").User>;
    ...
    findAllExcpt(email: string): Promise<import("./users.entity").User[]>;
